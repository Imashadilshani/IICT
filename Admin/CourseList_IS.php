...
$str=@mysql_query("SELECT * FROM courses where course_category='Information Systems'");
...
<body>
    ...
    <body class="fixed-left">
        ...
        <div class="content-page">
            ...
            <div class="content">
								<!-- Page Heading Start -->
            			<h3 class="page-header" style="color:darkblue; text-decoration: underline;">Information System Subjects</h3>
            		           	</div>
