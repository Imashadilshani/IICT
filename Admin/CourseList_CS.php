...
$str=@mysql_query("SELECT * FROM courses where course_category='Computer Science'");
...
<body>
    ...
    <body class="fixed-left">
        ...
        <div class="content-page">
            ...
            <div class="content">
                                <!-- Page Heading Start -->
                        <h3 class="page-header" style="color:darkblue; text-decoration: underline;">Computer Science Subjects</h3>
                                </div>
