...
<body>
    ...
    <body class="fixed-left">
       ...
       <label for="input-text"><h5 style="font-style: italic; font-weight: bold; ">Select Year : </h5></label>

  <input name="search" type="search" placeholder="Type Your Year..." style="height:34px; width: 700px;" autofocus><input type="submit" class="btn btn-primary" name="button">
